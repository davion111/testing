...
<section>
  <nav class="flex-align-content-stick-top flex-justify-content-between padding-top-bottom body-content-width">
  	<div class="line-height" style="padding-left: 20px; margin-left: 10px; border: 1px solid #ccc!important; width: 100%;"> 
  		<div class="pull-lefts font-weight-bold">Desktop SMS</div>
  		<div class="pull-rights">Create Link</div>
  		<div class="pull-rights">?</div>
  		<div class="pull-rights">Sign Out</div>
  	</div>
  </nav>
</section>
<section>
  <div class="body-content-width body-content-height flex-justify-content-between">
    <div id="setup-max-width" class="pull-lefts flex-align-self-start" style="padding-left: 20px; border: 1px solid #ccc!important; margin-left: 10px; margin-right: 10px;">
      ...
      <div class="padding-left-right padding-top-bottom">
  			...
  			<div class="line-height">Branch-hosted SMS Landing Page</div>
  			<div class="line-height">Deepviews Content Previews with SMS</div>
  			<div class="line-height">Custom Landing Page with SMS</div>
  		</div>
        ...
        <div class="line-height">
  			...
  			<div>Your desktop redirects will also be updated in <a> Link Settings</a></div>
      ...
      <a class="flex-justify-content-end"> 
  		...
  		<div class="flex-justify-content-between">
  			<div class="pull-lefts">
  				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQ267CaRWJ9d940L36FfnIf7YZC7budeUoeTVLM3QdVRsO5vfAag" height="300" width="300">
  			</div>
  			<div class="padding-left-right">
  				...
  				<div>
            <p style="margin-top: 7.7em; font-size: 0.7em;">Enter your phone number to download apps</p>
